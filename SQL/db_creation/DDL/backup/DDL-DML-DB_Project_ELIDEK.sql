...
--
-- Host: localhost:8889
-- Generation Time: Jun 05, 2022 at 02:38 PM
...
('BETTERYEAR', 'BetterYear Inc', 'BetterYear', '99', 54321, 'Cupertino', 'RESEARCH CENTER', 100000, 500000, 0),
...
('GOODYEAR', 'Goodyear', 'Fifth Avenue', '365', 12345, 'New York City', 'COMPANY', 0, 0, 500000),
...
(250, 'Alpha', 'its alpha', 100000, '2020-06-05', '2023-06-05', 3, 'GOODYEAR'),
(251, 'BEta	', 'its beta', 100000, '2020-04-04', '2023-04-04', 3, 'GOODYEAR'),
(252, 'GHAMA	', 'ITS GHAMA', 200000, '2019-05-05', '2023-05-05', 5, 'GOODYEAR'),
(253, 'DELTA	', 'ITS DELTA	', 300000, '2021-06-06', '2023-06-06', 2, 'GOODYEAR'),
(254, 'Echo', 'its echo', 500000, '2019-07-07', '2023-07-07', 5, 'GOODYEAR'),
(255, 'hac habitasse platea dictumst', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus.', 611083, '2019-05-10', '2022-10-31', 4, 'GOODYEAR'),
(256, 'scelerisque mauris sit amet', 'Phasellus in felis. Donec semper sapien a libero. Nam dui.', 853626, '2019-09-12', '2023-08-31', 4, 'GOODYEAR'),
(258, 'odio cras', 'Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectus.', 551523, '2019-07-12', '2023-01-16', 4, 'GOODYEAR'),
(259, 'luctus et ultrices posuere', 'Nullam porttitor lacus at turpis. Donec posuere metus vitae ipsum. Aliquam non mauris.', 574420, '2019-10-29', '2022-04-20', 3, 'GOODYEAR'),
(260, 'sed tristique in tempus sit', 'Proin eu mi. Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem.', 110570, '2019-04-09', '2022-12-18', 4, 'GOODYEAR'),
(261, 'turpis elementum ligula vehicula', 'Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam. Cras pellentesque volutpat dui.', 943378, '2019-01-29', '2021-11-16', 3, 'GOODYEAR'),
(265, 'vitae ipsum aliquam non', 'Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam. Cras pellentesque volutpat dui.', 502822, '2019-11-20', '2022-12-07', 4, 'GOODYEAR'),
(266, 'sapien iaculis', 'Nullam sit amet turpis elementum ligula vehicula consequat. Morbi a ipsum. Integer a nibh.', 729490, '2019-11-06', '2021-11-08', 3, 'GOODYEAR'),
(267, 'odio porttitor id consequat in', 'Donec diam neque, vestibulum eget, vulputate ut, ultrices vel, augue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque.', 387009, '2019-12-06', '2020-05-25', 1, 'GOODYEAR'),
(268, 'congue eget semper', 'Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.', 749312, '2020-02-16', '2021-09-23', 2, 'GOODYEAR'),
(269, 'nam nulla integer pede justo', 'Aenean fermentum. Donec ut mauris eget massa tempor convallis. Nulla neque libero, convallis eget, eleifend luctus, ultricies eu, nibh.', 392179, '2020-07-31', '2021-02-07', 1, 'GOODYEAR'),
(270, 'convallis nulla neque', 'In sagittis dui vel nisl. Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus.', 590659, '2020-02-02', '2022-06-12', 3, 'GOODYEAR'),
(271, 'aliquet maecenas leo odio', 'Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.', 969886, '2020-02-23', '2021-12-03', 2, 'GOODYEAR'),
(273, 'losuere cubilia curae', 'Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.', 851769, '2020-05-31', '2023-09-28', 4, 'GOODYEAR'),
(274, 'nisl venenatis lacinia aenean sit', 'In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo.', 281540, '2020-06-30', '2021-12-13', 2, 'GOODYEAR'),
(275, 'felis fusce posuere', 'Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est.', 813218, '2020-08-28', '2023-04-24', 3, 'GOODYEAR'),
(276, 'at feugiat non', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.', 954697, '2020-09-11', '2022-04-16', 2, 'GOODYEAR'),
(277, 'mollis molestie', 'In congue. Etiam justo. Etiam pretium iaculis justo.', 663944, '2020-02-19', '2022-04-23', 3, 'GOODYEAR'),
(278, 'fusce lacus purus', 'Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque.', 969258, '2020-10-23', '2021-08-26', 1, 'GOODYEAR'),
(279, 'cum sociis natoque', 'Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque.', 714959, '2020-03-04', '2022-09-13', 3, 'GOODYEAR'),
(280, 'potenti nullam porttitor lacus at', 'Duis consequat dui nec nisi volutpat eleifend. Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus.', 767549, '2016-09-26', '2018-03-06', 2, 'BETTERYEAR'),
(281, 'cras non velit nec', 'Aenean lectus. Pellentesque eget nunc. Donec quis orci eget orci vehicula condimentum.', 198124, '2016-08-13', '2019-04-27', 3, 'BETTERYEAR'),
(282, 'pellentesque at nulla suspendisse', 'Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est.', 127180, '2016-07-01', '2018-05-29', 2, 'BETTERYEAR'),
(283, 'eu orci mauris lacinia', 'Aenean lectus. Pellentesque eget nunc. Donec quis orci eget orci vehicula condimentum.', 337339, '2016-11-12', '2019-04-03', 3, 'BETTERYEAR'),
(284, 'quam fringilla', 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.', 859837, '2016-05-08', '2018-10-27', 3, 'BETTERYEAR'),
(286, 'tempus vius in', 'In quis justo. Maecenas rhoncus aliquam lacus. Morbi quis tortor id nulla ultrices aliquet.', 802641, '2016-09-20', '2020-05-24', 4, 'BETTERYEAR'),
(287, 'convallis tortor risus dapibus augue', 'In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo.', 597664, '2016-03-12', '2017-03-17', 2, 'BETTERYEAR'),
(288, 'in lectus pellentesque at nulla', 'In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellus.', 104475, '2016-04-03', '2017-12-21', 2, 'BETTERYEAR'),
(289, 'nisl venenatis', 'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.', 562730, '2016-06-17', '2019-07-06', 4, 'BETTERYEAR'),
(290, 'eros elementum', 'Fusce consequat. Nulla nisl. Nunc nisl.', 939116, '2016-07-13', '2018-11-03', 3, 'BETTERYEAR'),
(291, 'in lacus curabitur', 'In quis justo. Maecenas rhoncus aliquam lacus. Morbi quis tortor id nulla ultrices aliquet.', 258781, '2016-02-06', '2020-01-03', 4, 'BETTERYEAR'),
(292, 'luctus rutrum', 'Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa. Donec dapibus. Duis at velit eu est congue elementum.', 447182, '2016-09-03', '2017-04-13', 1, 'BETTERYEAR'),
(293, 'faucibus orci luctus et', 'Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus.', 549635, '2016-10-15', '2019-03-28', 3, 'BETTERYEAR'),
(294, 'odio odio elementum eu', 'Sed ante. Vivamus tortor. Duis mattis egestas metus.', 326707, '2017-12-04', '2021-05-26', 4, 'BETTERYEAR'),
(295, 'auctor gravida sem praesent', 'Phasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum.', 237372, '2017-04-24', '2020-12-10', 4, 'BETTERYEAR'),
(296, 'sit amet justo', 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.', 526005, '2017-03-15', '2018-12-09', 2, 'BETTERYEAR'),
(297, 'odio elementum eu', 'In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellus.', 585834, '2017-09-21', '2021-06-06', 4, 'BETTERYEAR'),
(298, 'et ultrices', 'Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis.', 756617, '2017-07-09', '2017-08-29', 1, 'BETTERYEAR'),
(299, 'ipsum ac tellus semper interdum', 'Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.', 275508, '2017-10-29', '2018-01-05', 1, 'BETTERYEAR'),
(300, 'nibh ligula nec sem duis', 'Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.', 823164, '2017-05-12', '2021-02-07', 4, 'BETTERYEAR'),
(301, 'posuere cubilia curae duis', 'Fusce consequat. Nulla nisl. Nunc nisl.', 441634, '2017-03-15', '2019-09-02', 3, 'BETTERYEAR'),
(302, 'dictumst aliquam augue quam', 'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.', 837889, '2017-02-03', '2020-08-25', 4, 'BETTERYEAR'),
(303, 'varius integer ac leo', 'Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.', 520970, '2017-03-12', '2020-08-20', 4, 'BETTERYEAR'),
(304, 'tempus sit amet sem', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin risus. Praesent lectus.', 859201, '2017-12-27', '2020-05-12', 3, 'BETTERYEAR'),
(305, 'justo etiam pretium iaculis justo', 'Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.', 723740, '2017-11-27', '2019-02-10', 2, 'BETTERYEAR'),
(306, 'at vulputate vitae nisl aenean', 'In congue. Etiam justo. Etiam pretium iaculis justo.', 359884, '2017-02-07', '2019-05-09', 3, 'BETTERYEAR');
INSERT INTO `Project` (`project_id`, `project_title`, `description`, `budget`, `start_date`, `date_end`, `duration`, `org_id`) VALUES
(307, 'duis accumsan odio', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.', 563101, '2019-08-27', '2022-10-20', 4, 'GOODYEAR'),
(308, 'accumsan odio', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.', 563101, '2019-08-27', '2022-10-20', 4, 'GOODYEAR');
...
('GOODYEAR', 210, '2019-01-01', '2030-12-31'),
('GOODYEAR', 220, '2018-01-01', '2025-12-31');
...
--
ALTER TABLE `Project`
  MODIFY `project_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=309;

--
-- AUTO_INCREMENT for table `researcher`
--
ALTER TABLE `researcher`
  MODIFY `researcher_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=221;
