...
**Οδηγίες εγκατάστασης για *Windows* και *ΜacOS***
---
...
3. Αντιγράφουμε τα αρχεία που βρίσκονται στο User Interface directory ([UI](https://github.com/jcchatzis/DB_Project_Elidek/tree/main/UI)) του repository, στον φακελο htdocs που υπάρχει στο MAMP.
