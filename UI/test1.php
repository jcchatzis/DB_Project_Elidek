            ...
            <div class="container">
                ...
                if($_GET){
                    ...
                    if(isset($_GET['button1'])) {
                        ...
                        $start_date = $_GET['sdate'];//echo $start_date;echo "<br>";
                        $duration = $_GET['duration'];//echo $duration;echo "<br>";
                        $manager_name = $_GET['managerName'];//echo $managerName;echo "<br>";
                        $project_title = $_GET['projectTitle'];//echo $projectTitle;echo "<br>";
               

                        
                        if (empty($project_title)){

                            if(empty($start_date) or $start_date=="mm-dd-yyy"){ 
                                $start_date = "1=1";
                            }else{
                            ...
                            if(empty($manager_name)){ 
                                ...
                                $manager_name="c.employer_name = '".$manager_name."'";
                            }

                            //echo $start_date;echo "<br>";
                            //echo $duration;echo "<br>";
                            //echo $managerName;echo "<br>";
