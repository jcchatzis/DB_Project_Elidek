 ...
 <br /><br /><br />
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Test 6</h2>
                <!-- Icon Divider-->
                <br>   
                <form method="get">
                ...
                if($_GET){
                    ...
                    // echo '<script>alert("'.  $_POST['name'] . ',  '.$_POST['email'].'")</script>';
                        $sql = "select count(b.researcher_id) number_of_projects,
                        ...
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col">Researcher Last Name</th>
                                <th scope="col">Researcher First Name</th>
